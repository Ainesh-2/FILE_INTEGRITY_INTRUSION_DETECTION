...
df_normal = generate_samples(
    "normal", 600, (0, 3), (0, 1), (0, 2), (0, 1), (0, 1), (1, 2))
df_ransom = generate_samples(
    "ransomware_like", 300, (50, 150), (0, 2), (0, 5), (0, 1), (30, 120), (5, 20))
df_malware = generate_samples(
    "malware_like", 300, (0, 5), (0, 2), (5, 15), (3, 10), (0, 2), (1, 4))
df_burst = generate_samples(
    "burst_activity", 300, (0, 3), (0, 1), (50, 150), (0, 1), (0, 2), (3, 8))
df_delete = generate_samples(
    "destructive_activity", 300, (0, 3), (50, 150), (0, 2), (0, 1), (0, 1), (2, 6))
